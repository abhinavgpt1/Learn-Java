...
public class CW27C_NestedInterfaceExample {
    public static void main(String[] args) {
        ...
        System.out.print("A's object: objA.fun1(): "); objA.fun1();
        System.out.println();
        ...
        System.out.print("A.B's object: objB.fun2(): "); objB.fun2();
        System.out.println();
        
        A.C objC = new A.C();
        System.out.println("A.C's object: objC.z: " + objC.z);
        System.out.print("A.C's object: objC.fun3(): "); objC.fun3();
    }
}
