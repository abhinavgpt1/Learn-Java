...
class SubClass extends SuperClass {
	// void method() throws FileNotFoundException { // error: method() in SubClass cannot override method() in SuperClass
...
public class CW35a_ExceptionMethodOverriding {
	public static void main(String args[]) {
		...
		refBase.method2(); // no exception handling required for checked exception, can for Runtime exceptions (not recommended)
	}
	/**
	 * Output:
	 * -------
	 ...
	 *         at CW35a_ExceptionMethodOverriding.main(CW35a_ExceptionMethodOverriding.java:28)
	 */
}
