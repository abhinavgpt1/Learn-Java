public class CW38_String1_ConstantPool {
    public static void main(String args[]) {
        ...
        System.out.println("\ts1_literal == s2_literal: " + (s1_literal == s2_literal));
        System.out.println("\ts1_literal == s3_dynamic_obj: " + (s1_literal == s3_dynamic_obj));
        System.out.println("\ts1_literal == s4_dynamic_obj: " + (s1_literal == s4_dynamic_obj));
        System.out.println("\ts2_literal == s3_dynamic_obj: " + (s2_literal == s3_dynamic_obj));
        System.out.println("\ts2_literal == s4_dynamic_obj: " + (s2_literal == s4_dynamic_obj));
        System.out.println("\ts3_dynamic_obj == s4_dynamic_obj: " + (s3_dynamic_obj == s4_dynamic_obj));
        System.out.println("Using equals() to compare values:");
        System.out.println("\ts1_literal.equals(s2_literal): " + s1_literal.equals(s2_literal));
        System.out.println("\ts1_literal.equals(s3_dynamic_obj): " + s1_literal.equals(s3_dynamic_obj));
        System.out.println("\ts1_literal.equals(s4_dynamic_obj): " + s1_literal.equals(s4_dynamic_obj));
        System.out.println("\ts2_literal.equals(s3_dynamic_obj): " + s2_literal.equals(s3_dynamic_obj));
        System.out.println("\ts2_literal.equals(s4_dynamic_obj): " + s2_literal.equals(s4_dynamic_obj));
        System.out.println("\ts3_dynamic_obj.equals(s4_dynamic_obj): " + s3_dynamic_obj.equals(s4_dynamic_obj));
