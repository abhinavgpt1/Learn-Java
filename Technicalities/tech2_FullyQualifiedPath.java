...
public class tech2_FullyQualifiedPath
{
    public static void main(String[] args)
    {
        ...
        Technicalities.packTech3.A.fun();
        Technicalities.packTech3.B.fun();
     ...
     * Executing commands
     * ------------------
     * CW core java> javac .\Technicalities\tech2_FullyQualifiedPath.java
     * CW core java> java Technicalities.tech2_FullyQualifiedPath
     *
     * Output:
     * -------
     * inside A
